...
function SelectHub({handleChange, titleSelect=""}) {
    ...
    return ( <MainSelect title={titleSelect} list={list} defaultValue={activeHub!=null ? activeHub : list[0].id} handleChange={handleChange} /> );
}
